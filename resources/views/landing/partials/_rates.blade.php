<section class="section" id="rates">
    ...
    <div class="grid plans-grid">
        <div class="card glass">
            <div class="panel-tag">نماینده کیف پول</div>
            <h3 style="margin: 10px 0 4px;">پرداخت به تومان — شارژ کیف پول</h3>
            <p class="muted">حساب ریسلر با تومان شارژ می‌شود. شارژ اولیه برای فعال‌سازی: ۱۵۰,۰۰۰ تومان. محدودیت کانفیگ: نامحدود.</p>
            <div class="price">شارژ اولیه موردنیاز: ۱۵۰,۰۰۰ تومان</div>
        ...
        <div class="card glass">
            <div class="panel-tag">نماینده ترافیکی</div>
            ...
            @endif
            <p class="muted">شارژ اولیه: ۱۰۰۰ گیگابایت. هر زمان نیاز بود ترافیک اضافه خریداری کنید.</p>
