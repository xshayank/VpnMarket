<section class="section" id="rates">
    ...
    <div class="grid plans-grid">
        <div class="card glass">
            ...
            <p class="muted">حساب ریسلر با تومان شارژ می‌شود. شارژ اولیه برای فعال‌سازی: ۱۵۰,۰۰۰ تومان. محدودیت کانفیگ: نامحدود (نماینده کیف پول محور). کاربران نهایی: نامحدود.</p>
