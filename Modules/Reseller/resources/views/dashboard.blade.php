<x-app-layout>
    ...
    <div class="py-6 md:py-12">
        <div class="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 space-y-3 md:space-y-6">
            ...
            {{-- Reseller Type Badge --}}
            <div class="p-3 md:p-4 bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg text-right">
            ...
            @if ($reseller->isPlanBased())
                ...
                @endif
            @else
                {{-- Traffic/Wallet-based reseller - Use Livewire Component --}}
                @livewire('reseller.configs-manager')
            @endif
        </div>
    </div>
</x-app-layout>
