        ...
        return [
            ...
            [
                ...
                'body' => [
                    ...
                    'data_limit' => 'required|int (bytes) - Traffic limit in bytes, cast to integer',
                    ...
                    'usage_duration' => 'required_if:expire_strategy=start_on_first_use|int (seconds) - Duration in seconds from first use',
                ...
                'notes' => [
                    ...
                    'For start_on_first_use strategy: usage_duration (seconds) is required',
            ...
            [
                ...
                'scope' => 'users:update',
                'body' => [
                    'data_limit' => 'optional|int (bytes) - Traffic limit in bytes',
                    ...
                    'usage_duration' => 'optional|int (seconds) - For start_on_first_use strategy',
